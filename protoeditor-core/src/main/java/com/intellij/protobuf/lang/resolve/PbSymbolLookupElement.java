...
public class PbSymbolLookupElement extends LookupElement {
  ...
  private ColorValue highlightColor = null;

  public PbSymbolLookupElement(PbSymbol symbol) {
    this(symbol, symbol.getName(), IconDescriptorUpdaters.getIcon(symbol, 0));
  }

  private PbSymbolLookupElement(PbSymbol symbol, String name, Image icon) {
    this.symbol = symbol;
    this.name = name;
    this.icon = icon;
  }
  ...
  private void setRedHighlight() {
    this.highlightColor = StandardColors.RED;
  }
